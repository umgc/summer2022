...
import '../lib/daily_digest_files.dart';
...
void main() async {
  var jsonList = [
    ...
    },
    {
      "addresses": [
        {
          ...
          "address": "650 Liberty Avenue Union; NJ 07083",
          "validated": false
        },
        {
          "type": "recipient",
      ...
      "codes": [
        {"type": "url", "info": "https://bedbathandbeyond.com"}
      ]
    },
    {
      "addresses": [
      ...
      "addresses": [
        {
          "type": "sender",
          "name": "Ben Carlson",
          "address": "15300 Poplar Hill; Accokeek, MD 20607-3504",
          "validated": false
        },
        {
          "type": "recipient",
    ...
    },
    {
      ...
      "codes": [
        {"type": "url", "info": "https://homedepot.com"}
      ]
    },
    {
      "addresses": [
        {
          "type": "sender",
          "name": "Katie Johnson",
          "address": "4600  Pebbleshire; Waldorf, MD 20602-4108",
          "validated": false
        },
        {
          "type": "recipient",
      ...
      "addresses": [
        {
          "type": "sender",
          "name": "BGE",
          "address": "1068 N. Front St.; Baltimore, MD 21202",
          "validated": false
        },
        {
          "type": "recipient",
  ...
  group("Daily Digest Files Tests", () {
    ...
    test("Read From File", () async {
      ...
      try {
        MailResponse? dailyDigest =
            await handleFiles.readFromFile('2020-06-01.json');
    ...
    test("Get Daily Digest by Date", () async {
      ...
      try {
        MailResponse? dailyDigest =
            await handleFiles.getDailyDigestByDate('2020-06-01');
        expect(json.encode(dailyDigest), json.encode(mail));
      } catch (e) {
        error = e.toString();
      }
